...
public class User {
  ...
  @NotBlank(message = "The first name field is reuqired")
  @Size(min=3,message = "The first name field has to be more than 3 characters")
  private String first_name;
	
  @NotBlank(message = "The last name field is reuqired")
  @Size(min=3,message = "The last name field has to be more than 3 characters")
  private String last_name;
	
  @Email
  @NotBlank(message = "The email field is reuqired")
  @Pattern(regexp = "([a-zA-Z0-9]+(?:[._+-][a-zA-Z0-9]+)*)@([a-zA-Z0-9]+(?:[.-][a-zA-Z0-9]+)*[.][a-zA-Z]{2,})",
  message="Please enter a valid email address")
	private String email;
	
  @NotBlank(message = "The password field is reuqired")
  private String password;
	
  @NotBlank(message = "The confirm password field is reuqired")
  private String confirm_password;
	
  @NotBlank(message = "The user type field is reuqired")
